...
def generate_signals(df):
    """
    Breakout with IBS Filter Strategy
    
    This strategy looks for new highs combined with an oversold IBS reading,
    indicating a strong breakout that closed near the low of its range and may continue higher.
